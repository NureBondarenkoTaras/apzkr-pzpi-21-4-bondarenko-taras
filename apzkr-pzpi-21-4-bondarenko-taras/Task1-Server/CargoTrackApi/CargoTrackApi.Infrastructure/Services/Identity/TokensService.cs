...
namespace CargoTrackApi.Infrastructure.Services.Identity;
...
public class TokensService : ITokensService
{
    ...
    private JwtSecurityToken GetTokenOptions(IEnumerable<Claim> claims)
    {
        ...
        var secretKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_configuration.GetValue<string>("JsonWebTokenKeys:IssuerSigningKey")));
